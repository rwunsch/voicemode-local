...
| 8 | [`issue-simpleaudio-blocks-windows.md`](issue-simpleaudio-blocks-windows.md) | new issue | Bug report | **High** — proven by a resolver run, one-line fix, and the dep has broken installs in #117/#13/#319 already |
